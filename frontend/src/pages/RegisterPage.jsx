...
const RegisterPage = () => {
  ...
  return (
    <div className="hero min-h-[90vh] bg-black">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          <h1 className="text-5xl font-bold">Create Your Account</h1>
          <p className="py-6">Track your expenses with ease!</p>
        </div>
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-zinc-900">
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting, resetForm }) => {
                try {
                  ...
                  await axios.post("/api/v1/settings/add-setting", {
                    userid: values.email,
                  });
                  setSubmitting(false);
